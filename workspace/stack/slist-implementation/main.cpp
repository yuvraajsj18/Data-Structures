//  WAP to implement stacks using Linked Lists as discussed in class (LinkedStack class)
...
int main()
{
    cout << "Stack implemented as Linked List";
    ...
    while(true)
    {
        ...
        switch(choice)
        {
            ...
            break;
            case 7:
                cout << "Size of stack is " << my_stack.size() << endl;
            break;
            case 8:
                exit(0);
            break;
