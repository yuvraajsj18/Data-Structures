...
template <typename type>
typename NodeList<type>::Iterator& NodeList<type>::Iterator::operator++()
{
    node = node->next;
    return *this;
}
...
template <typename type>
inline typename NodeList<type>::Iterator NodeList<type>::begin() const
{
    return Iterator(header->next);
}

template <typename type>
inline typename NodeList<type>::Iterator NodeList<type>::end() const 
{
...
template <typename type>
type NodeList<type>::erase_front()
{
    return erase(begin());
}

template <typename type>
type NodeList<type>::erase_back()
{
    return erase(--end());
}
